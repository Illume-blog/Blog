...
function Header() {
    ...
    function onMyBlogs() {
        history.push(
            {
                pathname: '/user',
                search: '?query=' + 'IU34wf4yDzg0PNwWeQHtVhsCT9x2',
                state: { blogs: myBlogs }
            }
        )
    }
        ...
        <div className="header">
            <div className="inner_header">
                ...
                <div className="navigation">
                    ...
                    <button id="myBlog" onClick={async () => { await fetchMongoDataOfUser('IU34wf4yDzg0PNwWeQHtVhsCT9x2'); console.log(myBlogs); onMyBlogs(); }} >
